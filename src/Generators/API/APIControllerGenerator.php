...
class APIControllerGenerator extends BaseGenerator
{
    ...
    public function __construct(CommandData $commandData)
    {
        ...
        if (strpos($commandData->modelName,'/') !== false){
            ...
            $this->path = $commandData->config->pathApiController.$path_fileName[0].'/';
            $this->fileName = $path_fileName[1].'APIController.php';
        } else {
    ...
    public function generate()
    {
        ...
        $templateData = get_template("api.controller.$templateName", 'lumen-generator');
